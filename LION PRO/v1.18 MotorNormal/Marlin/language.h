...
//SAG20150818
	...
	#define LANGUAGE_CHOICE 2  // 1: Spanish - 2: Any other (English default). For some console messages translation.
#endif
...
#elif MB(LIONHEART_PRO) //SAG20150811
  #define MACHINE_NAME "LEGIO"
  #define FIRMWARE_URL "http://www.leon-3d.es/repositorio/"
...
#define MSG_M115_REPORT                     "FIRMWARE_NAME:Marlin " BUILD_VERSION " FIRM_VER:" FIRMWARE_VERSION " SOURCE_CODE_URL:" SOURCE_CODE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) "\n"
