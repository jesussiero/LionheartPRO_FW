...
bool flag_cancel_print = false; //SAG20160126
  ...
  if (cleaning_buffer_counter)
  {
    ...
    plan_discard_current_block();
      ...
      if ((cleaning_buffer_counter == 1) && (SD_FINISHED_STEPPERRELEASE)) {
        if (flag_cancel_print) {//SAG20160126
          flag_cancel_print = false;
          ////enqueuecommands_P(PSTR("G1 X20 Y180 F4800")); //SAG20160302
          enqueuecommands_P(PSTR("G28 X Y")); //SAG20160307
          //enqueuecommands_P(PSTR("M104 S0")); //Turn hotend off
          //enqueuecommands_P(PSTR("M106 S0")); //Turn fan off
          //enqueuecommands_P(PSTR("M140 S0")); //Turn bed off
        }
